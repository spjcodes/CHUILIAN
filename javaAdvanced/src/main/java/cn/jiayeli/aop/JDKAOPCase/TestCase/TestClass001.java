...
import cn.jiayeli.aop.JDKAOPCase.invocationHandles.ExceptionHandle2MySQL;
...
public class TestClass001 {
   Logger log1 =  LoggerFactory.getLogger(TestClass001.class);
    //3.
    Logger log = new ExceptionHandle2MySQL<>(log1, ApplicationStorage.getApplicationId()).createProxyObj();

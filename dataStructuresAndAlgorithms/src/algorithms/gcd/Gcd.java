 ...
 *
 *        algorithms.gcd(120,34) --> algorithms.gcd(86, 34) -->algorithms.gcd(52,34) -->dcd(34,18) -->dcd(18,16) --> algorithms.gcd(16,2)
 *        --> algorithms.gcd(14,2) -->algorithms.gcd(12,2) -->algorithms.gcd(10,2) -->algorithms.gcd(8,2) -->algorithms.gcd(6,2) -->algorithms.gcd(4,2) -->
 *        algorithms.gcd(2,0)
 *
 *    2.碾转相除法
 ...
 *    until a%b = 0 break
 *
 *        algorithms.gcd(120, 34) --> algorithms.gcd(34, 18) --> algorithms.gcd(18,16) -->
 *        gvd(16, 2) -->  algorithms.gcd(2, 8) --> algorithms.gcd(8,12) --> algorithms.gcd(12, 8)
 *        --> algorithms.gcd(8,4) --> algorithms.gcd(4,2) --algorithms.gcd(2, 0)
 *
 *
 */
public class Gcd {
